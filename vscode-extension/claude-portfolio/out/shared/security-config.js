...
exports.SECURITY_ERROR_MESSAGES = exports.SHARED_SECURITY_CONFIG = void 0;
exports.getSecurityErrorMessage = getSecurityErrorMessage;
exports.SHARED_SECURITY_CONFIG = {
    ALLOWED_COMMANDS: [
 ...
 */
exports.SECURITY_ERROR_MESSAGES = {
    'path-traversal': {
 ...
 */
function getSecurityErrorMessage(command, reason) {
    const errorInfo = exports.SECURITY_ERROR_MESSAGES[reason] || {
