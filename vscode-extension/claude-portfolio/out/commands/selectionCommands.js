...
class SelectionCommands {
     ...
     */
    async sectionToggleCommand(sectionType) {
        try {
            ...
            vscode.window.showInformationMessage(`${icon} ${sectionName} projects ${action} (${selectedInSection.length}/${sectionProjects.length})`);
        }
        catch (error) {
